...
with open(OUTDIR,'w') as f:
    sm_MWscheme=SMcalculator.SMcalculator(MH=125.,mt=173.,alphas=0.118,MZ=91.1875,MW=80.37)
    ...
    sm_alphascheme=SMcalculator.SMcalculator(MH=125.25,mt=172.69,alphas=0.118,MZ=91.1875,Deltaalpha=0.0590)
    printAndWrite(f,'AFBb(alpha scheme):',sm_alphascheme.get('AFBb'))
    sm_alphascheme2=SMcalculator.SMcalculator(scheme='alpha',input_dict={'MH':125.25,'mt':172.69,'alphas':0.118,'MZ':91.1875,'Deltaalpha':sm_MWscheme.Deltaalpha()}) # alternative constructor using dict
